...
type MainWindowViewModel() = 
    ...
    let boardView = BoardView.CreateFrom(GameSettings(19, Hard, Human), [(8, 6); (7, 5); (7, 7); (6, 8); (6, 6); (5, 5); (6, 5); (6, 4); (7, 6); (5, 6); (5, 4); (4, 3); (8, 7); (9, 8); (9, 7); (6, 7); (11, 7); (10, 7);])// (8, 8);])// (8, 5); (8, 9);])// (8, 10); (7, 9); ])//(6, 10); (10, 6);])// (9, 6); (11, 8);])// (11, 5); (12, 8);])// (7, 8); ])
