...
type MainWindowViewModel() = 
    ...
    //let boardView = BoardView.CreateFrom(GameSettings(19, Easy, Human), [(7, 8); (6, 7); (6, 8); (5, 8); (5, 7); (7, 9); (5, 9); (7, 7); (4, 8); (6, 6); (3, 9); (4, 9);])
    ...
    //let boardView = BoardView.CreateFrom(GameSettings(19, Easy, Human), [(6, 9); (5, 8); (5, 10); (7, 8); (4, 9); (5, 9); (6, 11); (3, 8); (6, 10); (6, 8); (4, 8); (4, 10); (3, 11); (6, 12); (4, 11); (5, 11); (3, 9); (5, 7); (7, 12); (8, 13); (4, 13); (5, 12); (3, 12); (2, 13); (5, 14); (6, 15); (3, 14); (3, 13); (4, 14); (6, 14);])// (6, 13); (8, 11); ])
    let boardView = BoardView.CreateFrom(GameSettings(19, Hard, Human), [(6, 9); (5, 8); (5, 10); (7, 8); (4, 9); (5, 9); (6, 11); (3, 8); (6, 10); (6, 8); (4, 8); (4, 10); (3, 11); (6, 12); (4, 11); (5, 11); (3, 9); (5, 7); (7, 12); (8, 13); (4, 13); (5, 12); (3, 12); (2, 13); (5, 14); (6, 15); (3, 14); (3, 13); (4, 14); (6, 14); (4, 12); (4, 15); (2, 10); 6, 13; 6, 16; 7, 13 ])
